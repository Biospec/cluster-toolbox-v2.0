function [transco2basl] = transco2basl(M,type)
%[transco2basl] = transco2basl(M,type)
...
elseif type ==3
    ...
    %%%for 2512 bin data
elseif type == 4
    transco2basl1=zeros(rows,88);
    for i=1:rows
       co2begin1=M(i,1115);
       co2end1=M(i,1203);
       slide1 = lintrans(1:88,1,88,co2begin1,co2end1);
       transco2basl1(i,:)=slide1;
    end
    ...
    for i=1:rows
        transco2basl(i,:)=[M(i,1:1114)';transco2basl1(i,:)';M(i,1204:2315)';...
            transco2basl2(i,:)';M(i,2331:2512)']';
    end
